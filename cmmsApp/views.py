...
# CHANGE BY JYOTI - 10-Sep-2026: Email OTP verification imports
import secrets
import hashlib
import hmac
import time
...
# CHANGE BY JYOTI - 10-Sep-2026: START - Email OTP backend for EngDesign website
# ============================================================
# CONTACT EMAIL OTP
# ============================================================
...
def request_demo_view(request):
    ...
    text_body = (
        "A new EngDesign enquiry request "
        "was submitted.\n\n"
        f"Submitted: {ts}\n"
...
def contact_section(request):
    ...
    if request.method == "POST" and form.is_valid():
        ...
        # Email body
        subject = "New website contact submission for EngDesign"
        text_body = "\n".join(
            [
                "New contact submission for EngDesign:",
...
def contact_block_submit(request):
    """
    Handles the EngDesign consulting/contact form.
    """
